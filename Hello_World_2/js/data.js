(function () {
    ...
    function generateSampleData() {
        ...
        var testImage = "images/nine_avatar.jpg";

        // Each of these sample groups must have a unique key to be displayed
        // separately.
        var sampleGroups = [
            { key: "group1", title: "Best Group Title", subtitle: "Group Subtitle: 1", backgroundImage: darkGray, description: groupDescription },
            { key: "group2", title: "Group Title: 3", subtitle: "Group Subtitle: 3", backgroundImage: mediumGray, description: groupDescription },
        ...
        var freyaContent = ["judjushdi"];

        // Each of these sample items should have a reference to a particular
        // group.
        var sampleItems = [
            { group: sampleGroups[0], title: "Best Item Title", subtitle: "Best Item Subtitle", description: itemDescription, content: itemContent, backgroundImage: testImage },
            { group: sampleGroups[0], title: "FREYA!!", subtitle: "OH MY GOODNESS DOGGY", description: itemDescription, content: freyaContent, backgroundImage: "/images/freya_1.jpg"},
